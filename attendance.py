...
class Attendace:
    def __init__(self,root):
        ...
        self.root.wm_iconbitmap(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\face.ico")
        ...
        # ===============Images==================================
        img10 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\smart-attendance.jpg")
        ...
        img11 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\iStock-182059956_18390_t12.jpg")
        ...
        img1 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\un.jpg")
        ...
        title=Label(self.root,text="STUDENT ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="blue")
        ...
        img30 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\face-recognition.png")
        ...
        btnAddData=Button(ButtonFrame1,text="Import csv",command=self.importData,font=("arial",11,"bold"),width=16,bg="blue",fg="white")
        btnAddData.grid(row=0,column=0,padx=1)

        btnUpdate=Button(ButtonFrame1,text="Export csv",command=self.export_data,font=("arial",11,"bold"),width=16,bg="blue",fg="white")
        btnUpdate.grid(row=0,column=1,padx=1)

        btnDelete=Button(ButtonFrame1,text="Update",command=self.action,font=("arial",11,"bold"),width=16,bg="blue",fg="white")
        btnDelete.grid(row=0,column=2,padx=1)

        btnReset=Button(ButtonFrame1,text="Reset",command=self.clear,font=("arial",11,"bold"),width=16,bg="blue",fg="white")
