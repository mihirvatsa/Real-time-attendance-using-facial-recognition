...
class Recognition_Face:
    def __init__(self,root):
        ...
        title=Label(self.root,text="FACE RECOGNITION",font=("times new roman",30,"bold"),bg="white",fg="blue")
        ...
        img_logo11 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\face_detector1.jpg")
        ...
        img_logo = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
        ...
        b3.place(x=350,y=500,width=200,height=40)
    ...
    def mark_attendace(self,d,k,s,i):
        with open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\day.csv","r+",newline="\n") as f:
    ...
    def detect_face(self):
        ...
        faceCascade=cv2.CascadeClassifier(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\haarcascade_frontalface_default.xml")
        clf= cv2.face.LBPHFaceRecognizer_create()
        clf.read(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\classifier.xml")
