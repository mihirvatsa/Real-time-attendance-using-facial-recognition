...
class Help:
    def __init__(self,root):
        ...
        img11 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\1_5TRuG7tG0KrZJXKoFtHlSg.jpeg")
        ...
        support=Label(bg_lbl,bg="white",text="Support:mihirvatsa6@gmail.com",fg="blue",font=("times new roman",20,"bold"))
