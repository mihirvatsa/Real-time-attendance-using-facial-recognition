...
class Student:
    def __init__(self,root):
        ...
        # ===============Images==================================
        img10 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\face-recognition.png")
        ...
        img11 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\smart-attendance.jpg")
        ...
        img13 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # ==================== Project title ==================================================
        title=Label(self.root,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",30,"bold"),bg="white",fg="blue")
        ...
        img_logo = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\31-311346_oxford-university-logo.png")
        ...
        img30 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\AdobeStock_303989091.jpeg")
        ...
        img20 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\gettyimages-1022573162.jpg")
        ...
        img30 = Image.open(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # ===================================ButtonFrame=====================================
        btnAddData=Button(ButtonFrame2,text="UPDATE",command=self.std_update,font=("arial",11,"bold"),width=23,bg="blue",fg="white")
        btnAddData.grid(row=0,column=0,padx=1)

        btnUpdate=Button(ButtonFrame2,text="DELETE",command=self.std_delete,font=("arial",11,"bold"),width=23,bg="blue",fg="white")
        btnUpdate.grid(row=0,column=1,padx=1)

        btnDelete=Button(ButtonFrame2,text="RESET",command=self.clear,font=("arial",11,"bold"),width=23,bg="blue",fg="white")
        btnDelete.grid(row=0,column=2,padx=1)

        # btnReset=Button(ButtonFrame2,text="RESET",command=self.clear,font=("arial",11,"bold"),width=17,bg="blue",fg="white")
        # btnReset.grid(row=0,column=3,padx=1)

        btnPhoto=Button(ButtonFrame1,text="SAVE STUDENT INFO/ADD PHOTO SAMPLE",command=self.generate_dataset,font=("arial",11,"bold"),width=72,bg="blue",fg="white")
    ...
    def generate_dataset(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_roll.get()=="" or self.usertype.get()==""):
            ...
            face_classified=cv2.CascadeClassifier(r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\haarcascade_frontalface_default.xml")
            ...
            while True:
                ...
                if face_cropped(frame) is not None:
                    ...
                    file_name_path=r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\collect_sample\user."+str(id)+"."+str(self.img_id)+".jpg"
    ...
    def std_delete(self):
        if self.ref_id.get()== 0:
            ...
            if emp_delete>0:
                ...
                file_name_path=r"C:\Users\gkc\Desktop\attend\Mini_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\collect_sample"
